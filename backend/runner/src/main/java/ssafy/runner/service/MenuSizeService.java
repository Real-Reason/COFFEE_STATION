...
import ssafy.runner.domain.dto.partner.MenuSizeCreateResponseDto;
...
//    @Transactional
//    public MenuSizeListCreateResponseDto createMenuSizeList2(String email, Long menuId, List<MenuSizeCreateRequestDto> menuSizeCreateRequestDtoList) {
...
//    }
    ...
    @Transactional
    public MenuSizeCreateResponseDto createMenuSizeList(String email, Long menuId, Long sizeId, int price) {
        ...
        return MenuSizeCreateResponseDto.of(menuSize);
    }
}
